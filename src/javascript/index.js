...
class Player {
  ...
  loadSong() {
    ...
    this.audio.onloadedmetadata = () => this.$('.end-time').innerText = this.formateTime(this.audio.duration)
  ...
  setProgerssBar() {
    ...
    this.$('.start-time').innerText = this.formateTime(this.audio.currentTime)
